...
public class ZonedDateTimeEx {
	...
	public static void main(String[] args) {
		...
		ZonedDateTime jpDateTime = ZonedDateTime.now( ZoneId.of("Japan"));
		System.out.println("일본 표준시 : " + jpDateTime);
