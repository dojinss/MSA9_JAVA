...
@FunctionalInterface			// 컴파일러에 함수형 인터페이스임을 명시
...
public class LambdaFormat {
	public static void main(String[] args) {
		...
		FuncInterface1 f1 = () -> System.out.println("자바 람다식1");
		f1.method();
		
		// 매개변수 O, 반환타입 X 람다식
		// (a, b) -> {System.out.println(a + b);}
		FuncInterface2 f2 = (a, b) ->{
			String result = a + b;
		...
		FuncInterface4 f4 = (a, b) -> {return a + b;};
		//(에러) FuncInterface4 f5 = (a, b) -> return a + b;
		FuncInterface4 f6 = (a, b) -> a + b;
		
		String result4 = f4.method("자바", "람다식4");
		String result6 = f6.method("자바", "람다식6");
