...
public class CalendarEx {
	public static void main(String[] args) {
		...
		System.out.println();
		//						   /  밀리초 * 초 * 분 * 시 = Day
		long DoM = (1000 * 60 * 60 * 24);
		long dDay = (lastT - nowT) / DoM;
		...
		birth.set(1987, Calendar.OCTOBER ,13);
		
		long afterT = birth.getTimeInMillis();
		long afterDay = (nowT - afterT) / DoM; 
		System.out.println("생후 " + afterDay + "일이 지났습니다.");
		System.out.println();
	...
	private static void printCalendar(String msg, Calendar cal) {
		...
		System.out.print(hour + ":" + minute + ":" + second + " " + mSecond + "밀리초");
		System.out.println();
	}
}
